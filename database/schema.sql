...
CREATE TABLE IF NOT EXISTS auth_users (
  ...
  representative_player_id BIGINT UNSIGNED NULL,
  ...
  KEY idx_auth_users_representative_player (representative_player_id),
  CONSTRAINT fk_auth_users_representative_player
...
CREATE TABLE IF NOT EXISTS player_round_phase_stats (
  match_id BIGINT UNSIGNED NOT NULL,
  match_player_id BIGINT UNSIGNED NOT NULL,
  round_number SMALLINT UNSIGNED NOT NULL,
  side ENUM('T', 'CT') NOT NULL,
