...
Version 12 records each side's total equipment value and live player count at `round_freeze_end`, plus stable team identity and the pistol-round flag. Pistol rounds are regulation rounds 1 and 13 only. Non-pistol buys are derived per live player: Eco at $1,000 or less, Full Buy at $4,000 or more, and Force Buy between them. Storing the raw value and roster size lets those display thresholds change without another demo parse.
