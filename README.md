...
Pickup and equip events sometimes use the shared `hkp2000` family label for both CT starting pistols. NickStats uses the event's item definition index to distinguish the USP-S (61) from the P2000 (32).
