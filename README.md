...
Side-specific ADR records each enemy-damage event directly into the attacker's live CT or T bucket. Its numerator and rounds-played denominator therefore cover the same side rather than reconstructing side damage from a later full-match total.
