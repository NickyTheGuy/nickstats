(() => {
  ...
  const metricGroups = {
    ...
    context: [["Enemy blind", "blinded_kills", "countRate"], ["Player blind", "blind_kills", "countRate"], ["Wallbang", "wallbang_kills", "countRate"], ["Through smoke", "smoke_kills", "countRate"], ["Player airborne", "airborne_kills", "countRate"], ["Player moving", "moving_kills", "countRate"], ["Player still", "still_kills", "countRate"], ["Player running", "running_kills", "countRate"], ["Enemy grenade out", "grenade_out_kills", "countRate"], ["Enemy knife out", "knife_out_kills", "countRate"], ["Enemy equipment out", "equipment_disadvantage_kills", "countRate"], ["Any advantage", "unfair_kills", "countRate"]],
    contextDeaths: [["Player blind", "deaths_while_blind", "countRate", false], ["Enemy blind", "deaths_to_blind_killer", "countRate", false], ["Enemy wallbang", "wallbang_deaths", "countRate", false], ["Through smoke", "smoke_deaths", "countRate", false], ["Enemy airborne", "airborne_deaths", "countRate", false], ["Enemy moving", "moving_killer_deaths", "countRate", false], ["Enemy still", "still_killer_deaths", "countRate", false], ["Enemy running", "running_killer_deaths", "countRate", false], ["Player grenade out", "grenade_out_deaths", "countRate", false], ["Player knife out", "knife_out_deaths", "countRate", false], ["Player equipment out", "equipment_disadvantage_deaths", "countRate", false], ["Any disadvantage", "unfair_deaths", "countRate", false]],
  ...
  function renderComboProfile(current) {
    ...
    fillProfileList("comboKillContextStats", metricRows([["Enemy was blinded", s.blinded_kills], ["Player was blinded", s.blind_kills], ["Shot penetrated a surface", s.wallbang_kills], ["Shot passed through smoke", s.smoke_kills], ["Player was airborne", s.airborne_kills], ["Player was moving", s.moving_kills], ["Player was still", s.still_kills], ["Player was running", s.running_kills], ["Enemy had a grenade out (within 2s)", s.grenade_out_kills], ["Enemy had a knife out (within 2s)", s.knife_out_kills], ["Enemy had either out (unique)", s.equipment_disadvantage_kills], ["Any favorable context (unique)", s.unfair_kills]]));
    fillProfileList("comboDeathContextStats", metricRows([["Player was blinded", s.deaths_while_blind], ["Enemy was blinded", s.deaths_to_blind_killer], ["Enemy shot through a surface", s.wallbang_deaths], ["Enemy shot through smoke", s.smoke_deaths], ["Enemy was airborne", s.airborne_deaths], ["Enemy was moving", s.moving_killer_deaths], ["Enemy was still", s.still_killer_deaths], ["Enemy was running", s.running_killer_deaths], ["Player had a grenade out (within 2s)", s.grenade_out_deaths], ["Player had a knife out (within 2s)", s.knife_out_deaths], ["Player had either out (unique)", s.equipment_disadvantage_deaths], ["Any unfavorable context (unique)", s.unfair_deaths]]));
