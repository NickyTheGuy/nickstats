(() => {
  ...
  const metricGroups = {
    ...
    openings: [["Opening K", "opening_kills", "countRate"], ["Opening D", "opening_deaths", "countRate", false], ["Opening D traded", "opening_traded_deaths", "countRate"], ["Opening trade K", "opening_trade_kills", "countRate"], ["Assisted opening K", "opening_assisted_kills", "countRate"], ["Opening assists earned", "opening_assists", "countRate"], ["Damage opening assists", "opening_damage_assists", "countRate"], ["Flash opening assists", "opening_flash_assists", "countRate"], ["Damage-assisted", "opening_damage_assisted_kills", "countRate"], ["Flash-assisted", "opening_flash_assisted_kills", "countRate"], ["Enemy blind K", "opening_blinded_enemy_kills", "countRate"], ["Own flash K", "opening_own_flash_kills", "countRate"], ["Victim-side flash K", "opening_victim_side_flash_kills", "countRate"], ["Unknown flash K", "opening_blind_source_unknown_kills", "countRate"], ["Blind K", "opening_blind_kills", "countRate"], ["Blind D", "opening_deaths_while_blind", "countRate", false], ["Killer flash D", "opening_deaths_to_killer_flash", "countRate", false], ["Own-side flash D", "opening_deaths_to_own_side_flash", "countRate", false], ["Unknown flash D", "opening_deaths_blind_source_unknown", "countRate", false], ["Blind killer D", "opening_deaths_to_blind_killer", "countRate", false], ["Enemy assisted D", "opening_enemy_assisted_deaths", "countRate", false], ["Enemy damage-assisted D", "opening_enemy_damage_assisted_deaths", "countRate", false], ["Enemy flash-assisted D", "opening_enemy_flash_assisted_deaths", "countRate", false], ["Assist rate", "openingAssistRate", "percent"], ["Attempts", "openingAttempts", "countRate"], ["Attempt rate", "openingAttemptRate", "percent"], ["Opening diff", "openingDiff", "signedRate"], ["Success", "openingSuccess", "percent"]],
    ...
    utility: [["Utility dmg", "utilityDamage", "damageRate"], ["UD/R", "udr", "decimal"], ["HE dmg", "he_damage", "damageRate"], ["Fire dmg", "fire_damage", "damageRate"], ["HE thrown", "he_grenades_thrown", "countRate"], ["Flashes thrown", "flashbangs_thrown", "countRate"], ["Smokes thrown", "smokes_thrown", "countRate"], ["Fire thrown", "fire_grenades_thrown", "countRate"], ["Decoys thrown", "decoys_thrown", "countRate"], ["Enemies flashed", "enemies_flashed", "countRate"], ["Enemy blind sec", "blindSeconds", "secondsRate"], ["Teammates flashed", "teammates_flashed", "countRate", false], ["Teammate blind sec", "teammateBlindSeconds", "secondsRate", false], ["Self flash effects", "self_flashes", "countRate", false], ["Self blind sec", "selfBlindSeconds", "secondsRate", false], ["Flash assists", "flash_assists", "countRate"], ["Damage assists", "damage_assisted_kills", "countRate"], ["Teammate-flash K", "teammate_flash_assisted_kills", "countRate"], ["Own-flash K", "own_flash_kills", "countRate"]],
    context: [["Clawback kills", "clawback_kills", "countRate"], ["Even-state kills", "even_kills", "countRate"], ["Advantage kills", "advantage_kills", "countRate"], ["Cleanup kills", "cleanup_kills", "countRate"], ["Enemy blind", "blinded_kills", "countRate"], ["Player blind", "blind_kills", "countRate"], ["Wallbang kills", "wallbang_kills", "countRate"], ["Smoke kills", "smoke_kills", "countRate"], ["Airborne kills", "airborne_kills", "countRate"], ["Running kills", "running_kills", "countRate"], ["Enemy grenade out", "grenade_out_kills", "countRate"], ["Enemy knife out", "knife_out_kills", "countRate"], ["Paul kills", "equipment_disadvantage_kills", "countRate"], ["Bullshit kills", "unfair_kills", "countRate"]],
    contextDeaths: [["Bozo deaths", "bozo_deaths", "countRate", false], ["Even-state deaths", "even_deaths", "countRate", false], ["Outnumbered deaths", "disadvantage_deaths", "countRate", false], ["Cleanup deaths", "cleanup_deaths", "countRate", false], ["Player blind", "deaths_while_blind", "countRate", false], ["Enemy blind", "deaths_to_blind_killer", "countRate", false], ["Wallbang deaths", "wallbang_deaths", "countRate", false], ["Smoke deaths", "smoke_deaths", "countRate", false], ["Airborne enemy", "airborne_deaths", "countRate", false], ["Running enemy", "running_killer_deaths", "countRate", false], ["Player grenade out", "grenade_out_deaths", "countRate", false], ["Player knife out", "knife_out_deaths", "countRate", false], ["Paul deaths", "equipment_disadvantage_deaths", "countRate", false], ["Bullshit deaths", "unfair_deaths", "countRate", false]],
    killStage: [5, 4, 3, 2, 1].flatMap(alive => [[`K vs ${alive} alive`, `enemy_alive_${alive}_kills`, "countRate"], [`D vs ${alive} alive`, `enemy_alive_${alive}_deaths`, "countRate", false]]),
    rounds: [["Round wins", "round_wins", "countRate"], ["Bomb plants", "bomb_plants", "countRate"], ["Bomb defuses", "bomb_defuses", "countRate"], ["1v1 W/A", "clutch_1v1", "clutch1"], ["1v2 W/A", "clutch_1v2", "clutch2"], ["1v3 W/A", "clutch_1v3", "clutch3"], ["1v4 W/A", "clutch_1v4", "clutch4"], ["1v5 W/A", "clutch_1v5", "clutch5"], ["Multi-kill %", "multikillPercent", "percent"], ["1K rounds", "kill_rounds_1k", "countRate"], ["2K rounds", "kill_rounds_2k", "countRate"], ["3K rounds", "kill_rounds_3k", "countRate"], ["4K rounds", "kill_rounds_4k", "countRate"], ["5K rounds", "kill_rounds_5k", "countRate"], ["True multi %", "trueMultikillPercent", "percent"], ["True 2K rounds", "true_kill_rounds_2k", "countRate"], ["True 3K rounds", "true_kill_rounds_3k", "countRate"], ["True 4K rounds", "true_kill_rounds_4k", "countRate"], ["True 5K rounds", "true_kill_rounds_5k", "countRate"]],
    economy: [["Pistol rounds", "economy_pistol_rounds", "economyRate"], ["Pistol wins", "economy_pistol_wins", "economyWin:pistol"], ["Eco rounds", "economy_eco_rounds", "economyRate"], ["Eco wins", "economy_eco_wins", "economyWin:eco"], ["Force rounds", "economy_force_rounds", "economyRate"], ["Force wins", "economy_force_wins", "economyWin:force"], ["Full-buy rounds", "economy_full_rounds", "economyRate"], ["Full-buy wins", "economy_full_wins", "economyWin:full"]],
  ...
  function metricFields() {
    return (metricGroups[state.metricGroup] || metricGroups.core).map(field =>
      field[1] === "kpr" && state.roundResult !== "ALL"
  ...
  function formatMetric(value, type, stats = {}, key = "") {
    ...
    if (type === "economyRate") return Math.round(num(value)).toLocaleString();
    if (type.startsWith("economyWin:")) {
