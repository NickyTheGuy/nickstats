(() => {
  ...
  function renderProfile() {
    ...
    fillCards("playerTradeAttackStats", [["Opportunities", integer(s.trade_opportunities), countPerRound(s.trade_opportunities, s.rounds)], ["Attempts", integer(s.trade_attempts), `${countPerRound(s.trade_attempts, s.rounds)} · ${percent(100 * ratio(s.trade_attempts, s.trade_opportunities))} response`],
      ["Trade kills", integer(s.trade_kills), countPerRound(s.trade_kills, s.rounds)], ["Successful trades", integer(s.trade_successes), `${countPerRound(s.trade_successes, s.rounds)} · ${percent(100 * ratio(s.trade_successes, s.trade_attempts))} conversion`]]);
    ...
    fillMetricList("playerKillContextStats", [["Blinded enemies", s.blinded_kills], ["Kills while blind", s.blind_kills], ["Wallbang kills", s.wallbang_kills], ["Penetrations", s.penetration_total], ["Through smoke", s.smoke_kills], ["Airborne", s.airborne_kills], ["Grenade out", s.grenade_out_kills], ["Knife out", s.knife_out_kills], ["Equipment disadvantage", s.equipment_disadvantage_kills], ["Unfair fight", s.unfair_kills]].map(([label, value]) => metricPerRound(label, value)));
    fillMetricList("playerDeathContextStats", [["While blind", s.deaths_while_blind], ["To a blind killer", s.deaths_to_blind_killer], ["Wallbang", s.wallbang_deaths], ["Penetrations", s.death_penetration_total], ["Through smoke", s.smoke_deaths], ["Airborne killer", s.airborne_deaths], ["Moving killer", s.moving_killer_deaths], ["Still killer", s.still_killer_deaths], ["Running killer", s.running_killer_deaths], ["Grenade out", s.grenade_out_deaths], ["Knife out", s.knife_out_deaths], ["Equipment advantage", s.equipment_disadvantage_deaths], ["Unfair fight", s.unfair_deaths]].map(([label, value]) => metricPerRound(label, value)));
