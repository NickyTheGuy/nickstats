(() => {
  ...
  function renderProfile() {
    ...
    fillMetricList("playerKillContextStats", [["Enemy was blinded", s.blinded_kills], ["Player was blinded", s.blind_kills], ["Shot penetrated a surface", s.wallbang_kills], ["Shot passed through smoke", s.smoke_kills], ["Player was airborne", s.airborne_kills], ["Player was moving", s.moving_kills], ["Player was still", s.still_kills], ["Player was running", s.running_kills], ["Enemy had a grenade out (within 2s)", s.grenade_out_kills], ["Enemy had a knife out (within 2s)", s.knife_out_kills], ["Enemy had either out (unique)", s.equipment_disadvantage_kills], ["Any favorable context (unique)", s.unfair_kills]].map(([label, value]) => metricPerRound(label, value)));
    fillMetricList("playerDeathContextStats", [["Player was blinded", s.deaths_while_blind], ["Enemy was blinded", s.deaths_to_blind_killer], ["Enemy shot through a surface", s.wallbang_deaths], ["Enemy shot through smoke", s.smoke_deaths], ["Enemy was airborne", s.airborne_deaths], ["Enemy was moving", s.moving_killer_deaths], ["Enemy was still", s.still_killer_deaths], ["Enemy was running", s.running_killer_deaths], ["Player had a grenade out (within 2s)", s.grenade_out_deaths], ["Player had a knife out (within 2s)", s.knife_out_deaths], ["Player had either out (unique)", s.equipment_disadvantage_deaths], ["Any unfavorable context (unique)", s.unfair_deaths]].map(([label, value]) => metricPerRound(label, value)));
