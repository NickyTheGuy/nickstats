(() => {
  ...
  function render({ prefix, headlineId, summary, side, result = "ALL", roundResult = "ALL", maps }) {
    ...
    fillCards(`${prefix}OpeningStats`, [["Opening kills", integer(s.opening_kills), countPerRound(s.opening_kills, rounds)], ["Opening deaths", integer(s.opening_deaths), countPerRound(s.opening_deaths, rounds)], ["Opening deaths traded", integer(s.opening_traded_deaths), `${percent(100 * ratio(s.opening_traded_deaths, s.opening_deaths))} of opening deaths`], ["Opening trade kills", integer(s.opening_trade_kills), countPerRound(s.opening_trade_kills, rounds)], ["Assisted opening kills", integer(s.opening_assisted_kills), `${percent(100 * ratio(s.opening_assisted_kills, s.opening_kills))} of opening kills`], ["Opening assists earned", integer(s.opening_assists), countPerRound(s.opening_assists, rounds)], ["Damage opening assists", integer(s.opening_damage_assists), countPerRound(s.opening_damage_assists, rounds)], ["Flash opening assists", integer(s.opening_flash_assists), countPerRound(s.opening_flash_assists, rounds)], ["Damage-assisted openings", integer(s.opening_damage_assisted_kills), countPerRound(s.opening_damage_assisted_kills, rounds)], ["Flash-assisted openings", integer(s.opening_flash_assisted_kills), countPerRound(s.opening_flash_assisted_kills, rounds)], ["Opening attempt rate", percent(100 * ratio(openingTotal, rounds)), `${integer(openingTotal)} duels · ${countPerRound(openingTotal, rounds)}`], ["Opening differential", `${openingDiff >= 0 ? "+" : ""}${integer(openingDiff)}`, `${openingDiff >= 0 ? "+" : ""}${decimal(ratio(openingDiff, rounds), 2)} per round`], ["Opening success", percent(100 * ratio(s.opening_kills, openingTotal)), `${integer(s.opening_kills)} won · ${integer(s.opening_deaths)} lost`]]);
