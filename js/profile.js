(() => {
  ...
  function render({ prefix, headlineId, summary, side, result = "ALL", roundResult = "ALL", maps }) {
    ...
    fillCards(`${prefix}OpeningStats`, [["Opening kills", integer(s.opening_kills), countPerRound(s.opening_kills, rounds)], ["Opening deaths", integer(s.opening_deaths), countPerRound(s.opening_deaths, rounds)], ["Opening deaths traded", statInteger("opening_traded_deaths"), statAvailable("opening_traded_deaths") ? availabilityNote("opening_traded_deaths", `${openingPercent("opening_traded_deaths", "opening_traded_deaths", "opening_deaths")} of opening deaths`) : "Not available in these demos"], ["Opening trade kills", statInteger("opening_trade_kills"), statPerRound("opening_trade_kills")], ["Assisted opening kills", statInteger("opening_assisted_kills"), statAvailable("opening_assisted_kills") ? availabilityNote("opening_assisted_kills", `${openingPercent("opening_assisted_kills", "opening_assisted_kills", "opening_kills")} of opening kills`) : "Not available in these demos"], ["Opening assists earned", statInteger("opening_assists"), statPerRound("opening_assists")], ["Damage opening assists", statInteger("opening_damage_assists"), statPerRound("opening_damage_assists")], ["Flash opening assists", statInteger("opening_flash_assists"), statPerRound("opening_flash_assists")], ["Damage-assisted openings", statInteger("opening_damage_assisted_kills"), statPerRound("opening_damage_assisted_kills")], ["Flash-assisted openings", statInteger("opening_flash_assisted_kills"), statPerRound("opening_flash_assisted_kills")], ["Opening attempt rate", percent(100 * ratio(openingTotal, rounds)), `${integer(openingTotal)} duels · ${countPerRound(openingTotal, rounds)}`], ["Opening differential", `${openingDiff >= 0 ? "+" : ""}${integer(openingDiff)}`, `${openingDiff >= 0 ? "+" : ""}${decimal(ratio(openingDiff, rounds), 2)} per round`], ["Opening success", percent(100 * ratio(s.opening_kills, openingTotal)), `${integer(s.opening_kills)} won · ${integer(s.opening_deaths)} lost`]]);
